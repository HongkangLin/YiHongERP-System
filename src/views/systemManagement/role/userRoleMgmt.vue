    ...
    <div class="userRoleMgmt">
      <div class="search">
        <div class="head">
          ...
          <div class="new" v-if="roleCtl.role_add" @click="addRole">新增角色</div>
        </div>
        <div class="content">
          <div class="inputDiv">
      ...
      <div class="table">
        <el-table
          ...
          <el-table-column label="操作" align="center" v-if="roleCtl.role_update || roleCtl.role_delete">
            <template slot-scope="scope">
              <el-button
                type="text"
                size="mini"
                v-if="roleCtl.role_update"
                @click="handleEdit(scope.$index, scope.row)">编辑</el-button>
              <el-divider direction="vertical" v-if="scope.row.roleType !== '超级管理员' && roleCtl.role_update && roleCtl.role_delete"></el-divider>
              <el-button
                size="mini"
                type="text"
                v-if="scope.row.roleType !== '超级管理员' && roleCtl.role_delete"
